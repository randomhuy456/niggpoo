...
const DatabasePass string   = "OUJ@#E$BNfeiwdjiedekNEIO#NOCFD#NO"//This is your mysql pass, so change it to whatever you're gonna use
const DatabaseTable string  = "Oblivion"

var clientList *ClientList = NewClientList()
var database *Database = NewDatabase(DatabaseAddr, DatabaseUser, DatabasePass, DatabaseTable)

func main() {
    tel, err := net.Listen("tcp", "137.220.62.152:1024")
    if err != nil {
        fmt.Println(err)
        return
    }
